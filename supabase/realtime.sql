...
-- expenses·places·place_votes·comments는 expenses.sql·collab.sql을 돌린 뒤에만 있다. 없으면 건너뛴다.
do $$
declare
  t text;
begin
  foreach t in array array['trips', 'trip_members', 'trip_days', 'items', 'checklist', 'expenses', 'places', 'place_votes', 'comments']
  loop
