  ...
  },
  {
    ...
    table: {
      ...
      rows: [
        ...
        ['㈜카카오 (대한민국)', '국내 지도 표시, 장소 검색', '지도에 표시할 좌표, 검색어, 접속 IP'],
        ['Photon·Valhalla(OpenStreetMap 기반, 독일), Nominatim(OpenStreetMap 재단, 영국), Transitous(독일)', '장소 검색, 길찾기, 대중교통 조회', '검색어, 출발·도착 좌표, 접속 IP'],
  ...
  },
  {
    ...
    table: {
      ...
      rows: [
        ...
        ['Kakao Corp. (Korea)', 'Maps and place search in Korea', 'Map coordinates, search terms, IP address'],
        ['Photon, Valhalla (OpenStreetMap-based, Germany), Nominatim (OpenStreetMap Foundation, UK), Transitous (Germany)', 'Place search, directions, public transport', 'Search terms, start/end coordinates, IP address'],
  ...
  },
  {
    ...
    table: {
      ...
      rows: [
        ...
        ['Kakao Corp.（韓国）', '韓国国内の地図表示、場所検索', '地図に表示する座標、検索語、接続 IP'],
        ['Photon・Valhalla（OpenStreetMap ベース、ドイツ）、Nominatim（OpenStreetMap 財団、英国）、Transitous（ドイツ）', '場所検索、経路検索、公共交通の検索', '検索語、出発・到着の座標、接続 IP'],
