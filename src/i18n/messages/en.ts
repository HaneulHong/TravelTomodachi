...
export const en: Messages = {
  ...
  placeSearch: {
    ...
    domestic: 'Korea',
    overseas: 'Abroad',
    domesticPlaceholder: 'e.g. Gyeongbokgung, Seoul Station',
    overseasPlaceholder: 'e.g. Tokyo Skytree, Shinjuku',
    hint: 'Pick from search, or move the map to put the center pin on the spot',
    confirm: 'Use this location',
    nameOnly: 'Just the name, no location',
    mapUnavailable: "Couldn't load the map. Pick a search result or enter just the name.",
    noResultsKr: 'No results. You can move the map and use the center pin instead.',
    noResultsGlobal: 'No results. Try English or the local language, or move the map and use the pin.',
    clear: 'Clear place',
  },
