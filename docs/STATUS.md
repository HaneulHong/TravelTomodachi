...
- [x] PR #8 머지 (영어·일본어 지원 + 일정 순서·날짜 옮기기)
- [ ] **PR #9 머지** — 시각 순서 알림 + 첫 로그인 닉네임 + 오프라인 + 아이콘. DB 변경 없음
  - 머지 후 폰에서: 홈 화면에 추가한 적이 있으면 **지우고 다시 추가**해야 새 아이콘이 보인다
...
### 첫 로그인 닉네임 · 오프라인 · 아이콘 — 2026-09-24 (PR #9, 머지 대기)
...
### 시각과 순서가 어긋나면 알려주기 — 2026-09-24 (PR #9, 머지 대기)
