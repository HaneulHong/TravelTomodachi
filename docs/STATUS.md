...
- [ ] **PR #8 머지** (영어·일본어 지원 + 일정 순서·날짜 옮기기) — DB 변경 없음. 머지하면 자동 배포
...
### 일정 순서·날짜 옮기기 — 2026-09-24 (PR #8에 포함, 머지 대기)
...
### 영어·일본어 지원 — 2026-09-24 (PR #8, 머지 대기)
...
- 순서와 시각이 어긋나면 알려주기 (예: 12:00 다음에 09:00) — 지금은 순서를 바꿔도 시각은 그대로
